...
function Contents() {
  ...
  return (
    <>
      ...
      <a href="https://github.com/julhaas91/family-tree-2d/blob/master/CHANGELOG.md">
        <FormattedMessage
      ...
      <p className="ui right aligned version">
        ...
        <a
          href={`https://github.com/julhaas91/family-tree-2d/commit/${import.meta.env.VITE_GIT_SHA}`}
        >
